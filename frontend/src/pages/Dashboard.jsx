        ...
        <div className="pdf-popup-overlay">
          <div className="pdf-popup-card">
            ...
            <div className="pdf-popup-actions">
              <a href={pdfUrl} download={`Medical-Bill-${generatedBillNo || 'invoice'}.pdf`} className="pdf-btn-download" onClick={() => { setShowPdfPopup(false); setPdfUrl(null); setPdfBlob(null); }}>
